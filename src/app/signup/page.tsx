        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold">Stay Hard. Stay Registered.</h2>
              <p className="mt-2 text-gray-600">
                No excuses. Join your mentally tough workspace.
              </p>
            </div>
            ...
            {!isVerificationStep ? (
              ...
              <div className="space-y-5">
                ...
                <div className="flex justify-center gap-2">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      onPaste={handlePaste}
                      className="w-12 h-14 text-center font-bold text-lg border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    />
                  ))}
                </div>
                ...
                {otpMessage && (
                  <div className="p-3 bg-green-50 text-green-600 rounded-md text-sm" role="alert">
                    {otpMessage}
                  </div>
                )}
