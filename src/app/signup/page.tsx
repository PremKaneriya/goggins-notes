  ...
  const verifyOTP = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/auth/signup", {
        method: "PUT",
        body: JSON.stringify({ user: userId, otp: otpValue }),
        headers: {
        ...
        <div className="p-6 sm:p-8">
          ...
          {!isVerificationStep ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5" encType="multipart/form-data">
                ...
                <div>
                  ...
                  <div className="flex justify-between mt-1">
                    <p className="text-xs text-gray-500">
                      {user.countryCode} + {getCurrentCountryInfo().maxLength} digits
                    </p>
                    {user.phoneNumber && (
              ...
              {/* Error Message */}
              {error && <div className="p-2.5 bg-red-50 text-red-600 rounded-lg text-sm">{error}</div>}
            ...
            <div className="space-y-6">
              ...
              {error && <div className="p-2.5 bg-red-50 text-red-600 rounded-lg text-sm text-center">{error}</div>}
              {otpMessage && <div className="p-2.5 bg-green-50 text-green-600 rounded-lg text-sm text-center">{otpMessage}</div>}
