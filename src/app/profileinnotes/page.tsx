...
export default function Profile() {
  ...
  return (
    ...
    <footer className="border-t border-gray-100 pt-6 text-center text-sm text-gray-500">
        ...
        <footer className="border-t border-gray-100 pt-6 text-center text-sm text-blue-500">
              <p><a
               href="https://github.com/PremKaneriya" target="_blank" rel="noreferrer">About</a></p> 
        </footer>
        </div>          
      </div>
        </>
